...
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 263 0 8135540"); 
...
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 263 1 8135540"); 
...
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 263 2 8135540"); 
		this.user = user;
		this.pwd = pwd;
	}
...
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 263 3 8135540"); 
