...
public class SqlSessionException extends PersistenceException {
  ...
  public SqlSessionException() {
    super();
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 276 0 8135540"); 
  }

  public SqlSessionException(String message) {
    super(message);
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 276 1 8135540"); 
  }

  public SqlSessionException(String message, Throwable cause) {
    super(message, cause);
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 276 2 8135540"); 
  }

  public SqlSessionException(Throwable cause) {
    super(cause);
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 276 3 8135540"); 
  }
}
