...
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 0 8135540"); 
		...
		public boolean matches(
				Class<?> type) {
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 1 8135540"); 
			return type != null
					&& parent
...
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 2 8135540"); 
...
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 3 8135540"); 
		...
		public boolean matches(
				Class<?> type) {
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 4 8135540"); 
			return type != null
		...
		@Override
		public String toString() {
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 5 8135540"); 
...
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 6 8135540"); 
		return matches;
	}
...
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 7 8135540"); 
...
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 8 8135540"); 
	...
	public ResolverUtil<T> findImplementations(
			Class<?> parent,
			String... packageNames) {
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 9 8135540"); 
		if ((ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 10 8135540")|| true) && (packageNames == null? (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 0 0 1 0 ","8135540",true,1) || true): (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 0 0 0 0 ","8135540",false,0) && false))){ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 11 8135540");
			return this; }
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 12 8135540");

		Test test = new IsA(parent);
		for (String pkg : /* TRUE */packageNames){ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 13 8135540");ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 14 8135540"); {
			find(test, pkg);
		}}
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 15 8135540");
	...
	public ResolverUtil<T> findAnnotated(
			Class<? extends Annotation> annotation,
			String... packageNames) {
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 16 8135540"); 
		if ((ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 17 8135540")|| true) && (packageNames == null? (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 1 1 1 0 ","8135540",true,1) || true): (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 1 1 0 0 ","8135540",false,0) && false))){ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 18 8135540");
			return this; }
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 19 8135540");

		Test test = new AnnotatedWith(
				annotation);
		for (String pkg : /* TRUE */packageNames){ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 20 8135540");ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 21 8135540"); {
			find(test, pkg);
		}}
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 22 8135540");
	...
	public ResolverUtil<T> find(
			Test test,
			String packageName) {
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 23 8135540"); 
		String path = getPackagePath(packageName);

		try {ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 24 8135540"); 
			List<String> children = VFS
					.getInstance()
					.list(path);
			for (String child : /* TRUE */children){ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 25 8135540");ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 26 8135540"); {
				if ((ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 27 8135540")|| true) && (child
						.endsWith(".class")? (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 2 2 1 0 ","8135540",true,1) || true): (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 2 2 0 0 ","8135540",false,0) && false))){ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 28 8135540");
					addIfMatching(test,
							child); }
			}}
		} catch (IOException ioe) {ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 31 8135540"); 
			log.error(
					"Could not read package: "
							+ packageName,
					ioe);
		}
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 32 8135540");
	...
	protected String getPackagePath(
			String packageName) {
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 33 8135540"); 
...
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 34 8135540"); 
		try {ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 35 8135540"); 
			...
			if ((ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 36 8135540")|| true) && (test.matches(type)? (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 3 3 1 0 ","8135540",true,1) || true): (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 3 3 0 0 ","8135540",false,0) && false))){ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 37 8135540"); {
				matches.add((Class<T>) type);
			} }
		} catch (Throwable t) {ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 39 8135540"); 
	...
	public static String trimComma(
			String para) {
ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1001 207 41 8135540"); 
		if ((ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 42 8135540")|| true) && (StringUtils
				.isNotBlank(para)? (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 4 4 1 0 ","8135540",true,1) || true): (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 4 4 0 0 ","8135540",false,0) && false))){ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 43 8135540"); {
			if ((ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 44 8135540")|| true) && (para.endsWith(",")? (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 5 5 1 0 ","8135540",true,1) || true): (ZoaExp.ZoaMCDC(ZoaThreadLocal.G_Ins().G_CInf() + " 207 5 5 0 0 ","8135540",false,0) && false))){ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 45 8135540"); {
				return para
						.substring(
								0,
								para.length() - 1);
			} } else {  ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 46 8135540");  {
				return para;
			} }
		} } else {  ZoaExp.N(ZoaThreadLocal.G_Ins().G_CInf() + " 1000 207 48 8135540");  {
			return "";
		} }
	}
}